...
phone:yup.string().required('phone is Required').matches(/^01[0125][0-9]{8}$/,'phone number must be Egyptian number'),
  ...
  return <>
 <div className=' w-50 mx-auto py-2 text-white'>
...
<button disabled={!(formik.isValid&& formik.dirty)} className='sub-btn btn  m-auto  mt-2 w-100 ' type='submit'>Register</button>
}
